    ...
    <main className="min-h-screen bg-eco-bg bg-eco-grid overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-4 border-b border-eco-border/50">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-xl font-bold text-green-900">Soteria</span>
        </div>
        <div className="flex items-center gap-3">
          <Link
            href="/login"
            className="text-sm text-gray-400 hover:text-green-900 transition-colors px-4 py-2"
          >
            Log in
          </Link>
          <Link
      ...
      <section className="relative z-10 flex flex-col items-center text-center pt-20 pb-24 px-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-16">
          ...
          <Link
            href="/leaderboard"
            className="px-8 py-4 bg-eco-card border border-eco-border hover:border-brand-500/40 text-green-900 font-semibold rounded-2xl text-base transition-all active:scale-95"
          >
            View Leaderboard
          </Link>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 max-w-lg w-full">
          {[
            { value: "+1", label: "Point for each piece of trash" },
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            >
              ...
              <h3 className="text-green-900 font-bold text-lg mb-2">{title}</h3>
      ...
      <section className="relative z-10 px-6 pb-24">
        <div className="max-w-2xl mx-auto text-center mb-10">
          <h2 className="text-3xl font-black text-green-900 mb-3">Level Up Your Impact</h2>
      ...
      <section className="relative z-10 px-6 pb-24">
        <div className="max-w-xl mx-auto bg-gradient-to-br from-brand-900/40 to-eco-card border border-brand-500/25 rounded-3xl p-10 text-center">
          ...
          <h2 className="text-3xl font-black text-green-900 mb-3">Ready to save the planet?</h2>
          <p className="text-gray-400 text-sm mb-6">Join Soteria and turn your neighborhood cleanup into an adventure.</p>
          <Link
            href="/register"
      ...
      <footer className="relative z-10 border-t border-eco-border px-6 py-6 text-center text-xs text-gray-600">
        Soteria — Built at JAMhacks 2026 🌿
      </footer>
    </main>
  );
}
